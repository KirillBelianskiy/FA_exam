...
Реализуйте класс длинного целого числа `BetterBigInteger`. Класс должен быть спроектирован с учетом высокой эффективности использования памяти и поддерживать выполнение основных арифметических и поразрядных операций.
